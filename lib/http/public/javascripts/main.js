...
function init(state) {
  ...
  o('#retryAll').click(function(){
    o('#loading').show();

    o('input:checked').each(function () {
      console.log($(this).parent().find("a.remove"));
      $(this).parent().parent().find("a.retry").click();
  ...
  o('#removeAll').click(function(){
    o('#loading').show();
    o('input:checked').each(function () {
      console.log($(this).parent().find("a.remove"));
      $(this).parent().parent().find("a.remove").click();
      $(this).parent().parent().remove();
    });
      o('#loading').hide();
  });
