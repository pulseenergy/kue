...
Job.prototype.select = function(fn){
  return this;
};

Job.prototype.retry = function(fn){
  var item = {type: this.type, priority: this.priority, data: this.data};
  $.post('/jobs/job', item);
  return this;
};
...
Job.prototype.render = function(isNew){
  ...
  if (isNew) {
    ...
    // show details
    view.el.find('.toggleArea').toggle(function(){
